...
function validaDataNascimento(input) {
  ...
  if(maiorQue18(dataRecebida) === false) {
...
function validaCPF(input) {
  ...
  if(checaCPFRepetido(cpfFormatado) === false || checaEstruturaCPF(cpfFormatado) === false) {
...
function chegaDigitoVerificador(cpf, multiplicador) {
  ...
  if(digitoVerificador == confirmaDigiro(soma)) {
